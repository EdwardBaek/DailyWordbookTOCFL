> This Guide refers to [Joel Parker Henderson - how to write a good git commit message (GitHub)](https://github.com/joelparkerhenderson/git_commit_message/blob/master/README.md).
